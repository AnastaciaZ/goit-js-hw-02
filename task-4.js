function formatString (string, maxLength = 40) {
    const stringLength = string.split('', maxLength);
...
Если длина больше maxLength, то функция обрезает строку до размера maxLength символов и добавляет в конец строки
